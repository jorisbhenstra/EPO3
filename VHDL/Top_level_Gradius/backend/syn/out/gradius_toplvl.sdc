...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Dec 20 22:04:20 CET 2018
...
current_design gradius_toplvl

set_load -pin_load 1.0 [get_ports r]
set_load -pin_load 1.0 [get_ports g]
set_load -pin_load 1.0 [get_ports b]
set_load -pin_load 1.0 [get_ports h_sync]
set_load -pin_load 1.0 [get_ports v_sync]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports left]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports right]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports up]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports down]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports shoot]
